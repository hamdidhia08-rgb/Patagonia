    ...
    <header className={`w-full bg-white shadow-sm py-4 ${inter.className}`}>
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-7 text-black font-medium">
          <Link href="/" className="flex items-center gap-1 hover:text-orange-400 transition">
            Home
          </Link>

          <Link href="/Service" className="flex items-center gap-1 hover:text-orange-400 transition">
            Services
          </Link>

          <Link href="/tours" className="flex items-center gap-1 hover:text-orange-400 transition">
            Tours
          </Link>

          <Link href="/blog" className="flex items-center gap-1 hover:text-orange-400 transition">
            Blogs
          </Link>

          <Link href="/about" className="flex items-center gap-1 hover:text-orange-400 transition">
            About
          </Link>

          <Link href="/contact" className="flex items-center gap-1 hover:text-orange-400 transition">
            Contact
          </Link>
        </nav>
