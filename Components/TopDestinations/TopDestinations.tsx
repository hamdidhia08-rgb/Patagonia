    ...
    <section className="py-12 bg-white relative">
      <div className="max-w-7xl mx-auto px-6 mt-10">
        ...
        <div className="relative mb-16">
          {/* Image absolute à gauche */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-52 h-12">
            <Image
...
<div className="absolute right-0 top-1/2 -translate-y-1/2 w-28 h-28 flex items-center justify-center animate-spin-slow">
  <Image
    src="/images/home2-package-slider-vector2.svg"
    alt="Right Icon"
    width={70}
    height={70}
    className="object-contain block" // ✅ block important
  />
</div>
          ...
          {destinations.map((dest, index) => (
            <SwiperSlide key={index}>
              <div className="flex flex-col items-center text-center mt-10">
                <div className="w-40 h-40 md:w-50 md:h-50 rounded-full overflow-hidden mb-4 shadow-lg">
                  <Image
                    src={dest.image}
                    alt={dest.name}
                    width={350}
